__kernel void simple_multiplication( __global float* matrix_a, __global float* matrix_b, __global float* result, const int height, const int width, const int K)
{
